        ...
        <div className="row">
          <div className="col-md-12 home-screen align-items-center justify-content-center">
            {/* <img
              ...
              alt="Google Logo"
            /> */}
            <h1 style={{'fontFamily':'cursive',color:'#840704'}}>DeTectMyDc</h1>
            ...
            <div className="buttons col-md-4 ml-5 mt-4 align-items-center justify-content-center">
              ...
              <input
                ...
                onClick={() => handleSearch()}
              /> */}
              <p style={{'fontFamily':'cursive',color:'#840704'}}>Developed by <a href="https://www.facebook.com/zafrulhasan.nasim" target="_blank" style={{fontFamily:'cursive'}}>Zafrul Hasan Nasim</a></p>
            </div>
          </div>
        </div>
      </div>
